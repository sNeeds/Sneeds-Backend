...
from abroadin.apps.estimation.similarApply.models import AppliedStudentDetailedInfo
from abroadin.apps.estimation.similarApply.serializers import AppliedStudentDetailedInfoSerializer
