...
class OtherChartsFormCompletionTests(AnalyzeAPITestBase, FormCompletionBaseTestsMixin):
...
class OtherChartsUserEmailVerifiedTests(AnalyzeAPITestBase):
...
class OtherChartsFormOwnershipTests(AnalyzeAPITestBase):
