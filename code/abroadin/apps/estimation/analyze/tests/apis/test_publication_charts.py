...
from abroadin.apps.estimation.form.models import UniversityThrough, StudentDetailedInfo, GradeChoices, WantToApply
...
class PublicationChartsUserEmailVerifiedTests(EstimationBaseTest):
