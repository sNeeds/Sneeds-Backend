...
from abroadin.apps.estimation.form.models import WantToApply, StudentDetailedInfo, UniversityThrough, GradeChoices
...
class FormCommentsFormCompletionTests(EndpointMethodMixin, FormCompletionBaseTests):
...
class FormCommentsUserEmailVerifiedTests(EstimationBaseTest):
