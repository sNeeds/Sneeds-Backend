...
urlpatterns = [
    path('form/<int:form_id>/form-comments/', views.FormComments.as_view(), name="form-comments"),
    path('form/<int:form_id>/admission-ranking-chance/', views.AdmissionRankingChance.as_view(),
