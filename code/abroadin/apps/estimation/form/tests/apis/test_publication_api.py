...
class PublicationAPITest(FormAPITestBase):
    ...
    def deprecated_test_publication_list_get_200_1(self):
    ...
    def deprecated_test_publication_list_get_200_2(self):
    ...
    def deprecated_test_publication_list_get_200_3(self):
    ...
    def deprecated_test_publication_list_get_200_4(self):
        # TODO Change coed to be consistence with new form structure
        self.local_publication.student_detailed_info.user = self.local_user
        # TODO Change coed to be consistence with new form structure
        self.local_publication.student_detailed_info.save()
    ...
    def deprecated_test_publication_list_post_201_1(self):
        data = self._publication_list(
    ...
    def deprecated_test_publication_list_post_201_2(self):
    ...
    def deprecated_test_publication_list_post_400_1(self):
    ...
    def deprecated_test_publication_list_post_400_2(self):
        data = self._publication_list(
            "post", self.local_user, status.HTTP_400_BAD_REQUEST,
            data=self.publication_payload
        )

    def deprecated_test_publication_detail_get_200_1(self):
        data = self._publication_detail(
            "get", None, status.HTTP_200_OK, reverse_args=self.local_publication.id
        )
        self.assertEqual(len(data), 7)

    def deprecated_test_publication_detail_get_200_2(self):
        # TODO Change coed to be consistence with new form structure
        self.local_publication.student_detailed_info.user = self.local_user
        # TODO Change coed to be consistence with new form structure
        self.local_publication.student_detailed_info.save()
    ...
    def deprecated_test_publication_detail_get_403_1(self):
        # TODO Change coed to be consistence with new form structure
        self.local_publication.student_detailed_info.user = self.local_user
        # TODO Change coed to be consistence with new form structure
        self.local_publication.student_detailed_info.save()
    ...
    def deprecated_test_publication_detail_put_405_4(self):
        # TODO Change coed to be consistence with new form structure
        self.local_publication.student_detailed_info.user = self.local_user
        # TODO Change coed to be consistence with new form structure
        self.local_publication.student_detailed_info.save()
    ...
    def deprecated_test_publication_detail_patch_405_4(self):
        # TODO Change coed to be consistence with new form structure
        self.local_publication.student_detailed_info.user = self.local_user
        # TODO Change coed to be consistence with new form structure
        self.local_publication.student_detailed_info.save()
    ...
    def deprecated_test_publication_detail_delete_204_1(self):
        data = self._publication_detail(
    ...
    def deprecated_test_publication_detail_delete_204_2(self):
        # TODO Change coed to be consistence with new form structure
        self.local_publication.student_detailed_info.user = self.local_user
        # TODO Change coed to be consistence with new form structure
        self.local_publication.student_detailed_info.save()
    ...
    def deprecated_test_publication_detail_delete_401_1(self):
        # TODO Change coed to be consistence with new form structure
        self.local_publication.student_detailed_info.user = self.local_user
        # TODO Change coed to be consistence with new form structure
        self.local_publication.student_detailed_info.save()
    ...
    def deprecated_test_publication_detail_delete_403_1(self):
        data = self._publication_detail(
