...
from abroadin.settings.config.SkyroomConfig import BEFORE_AFTER_CLASS_TIME_MINUTES
from abroadin.apps.store.storeBase.models import SoldTimeSlotSale
from abroadin.apps.store.videochats.models import Room
from abroadin.apps.store.videochats.utils import create_2members_chat_room
...
def delete_room(room_id):
    from abroadin.apps.store.videochats.utils import delete_room
    delete_room(room_id)
