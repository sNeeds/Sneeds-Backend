...
from abroadin.apps.store.storeBase.serializers import TimeSlotSaleSerializer
from abroadin.apps.store.storeBase.models import SoldTimeSlotSale, TimeSlotSale, Product
from abroadin.apps.store.basicProducts.models import ClassProduct, WebinarProduct
from abroadin.apps.store.basicProducts.serializers import ClassProductSerializer, WebinarProductSerializer
from abroadin.apps.store.storePackages.models import StorePackage, SoldStoreUnpaidPackagePhase
from abroadin.apps.store.storePackages.serializers import StorePackageSerializer, SoldStoreUnpaidPackagePhaseSerializer
