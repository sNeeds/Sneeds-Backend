...
class StorePackageManager(models.QuerySet):
    ...
    def sell_and_get_sold_package(self, sold_to):
        from abroadin.apps.store.storePackages.models import SoldStorePackage, StorePackagePhaseThrough, \
...
class SoldStoreUnpaidPackagePhaseQuerySet(SoldStorePackagePhaseQuerySet):
    ...
    def sell_and_get_paid_phases(self):
        from abroadin.apps.store.storePackages.models import SoldStorePaidPackagePhase ,SoldStorePackagePhaseDetail
