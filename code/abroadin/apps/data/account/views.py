...
import abroadin.apps.estimation.form.serializers
from abroadin.base.api.enum_views import EnumViewList
from . import models
from . import serializers
from .models import BasicFormField
from abroadin.apps.estimation.form.models import StudentFormApplySemesterYear, StudentDetailedInfo, GradeChoices
...
from abroadin.apps.estimation.form.serializers import StudentFormApplySemesterYearSerializer, BasicFormFieldSerializer, \
...
class LanguageCertificateListCreateAPIView(custom_generic_apiviews.BaseListCreateAPIView):
    model_class = abroadin.apps.estimation.form.models.LanguageCertificate
    queryset = model_class.objects.all()
    serializer_class = abroadin.apps.estimation.form.serializers.LanguageCertificateSerializer
...
class LanguageCertificateRetrieveDestroyAPIView(custom_generic_apiviews.BaseRetrieveDestroyAPIView):
    ...
    model_class = abroadin.apps.estimation.form.models.LanguageCertificate
    queryset = model_class.objects.all()
    serializer_class = abroadin.apps.estimation.form.serializers.GMATCertificateSerializer
...
class RegularLanguageCertificateListCreateAPIView(LanguageCertificateListCreateAPIView):
    model_class = abroadin.apps.estimation.form.models.RegularLanguageCertificate
    queryset = model_class.objects.all()
    serializer_class = abroadin.apps.estimation.form.serializers.RegularLanguageCertificateSerializer
...
class GMATCertificateListCreateAPIView(LanguageCertificateListCreateAPIView):
    model_class = abroadin.apps.estimation.form.models.GMATCertificate
    queryset = model_class.objects.all()
    serializer_class = abroadin.apps.estimation.form.serializers.GMATCertificateSerializer
...
class GREGeneralCertificateListCreateAPIView(LanguageCertificateListCreateAPIView):
    model_class = abroadin.apps.estimation.form.models.GREGeneralCertificate
    queryset = model_class.objects.all()
    serializer_class = abroadin.apps.estimation.form.serializers.GREGeneralCertificateSerializer
...
class GRESubjectCertificateListCreateAPIView(LanguageCertificateListCreateAPIView):
    model_class = abroadin.apps.estimation.form.models.GRESubjectCertificate
    queryset = model_class.objects.all()
    serializer_class = abroadin.apps.estimation.form.serializers.GRESubjectCertificateSerializer
...
class GREBiologyCertificateListCreateAPIView(LanguageCertificateListCreateAPIView):
    model_class = abroadin.apps.estimation.form.models.GREBiologyCertificate
    queryset = model_class.objects.all()
    serializer_class = abroadin.apps.estimation.form.serializers.GREBiologyCertificateSerializer
...
class GREPhysicsCertificateListCreateAPIView(LanguageCertificateListCreateAPIView):
    model_class = abroadin.apps.estimation.form.models.GREPhysicsCertificate
    queryset = model_class.objects.all()
    serializer_class = abroadin.apps.estimation.form.serializers.GREPhysicsCertificateSerializer
...
class GREPsychologyCertificateListCreateAPIView(LanguageCertificateListCreateAPIView):
    model_class = abroadin.apps.estimation.form.models.GREPsychologyCertificate
    queryset = model_class.objects.all()
    serializer_class = abroadin.apps.estimation.form.serializers.GREPsychologyCertificateSerializer
...
class DuolingoCertificateListCreateAPIView(LanguageCertificateListCreateAPIView):
    model_class = abroadin.apps.estimation.form.models.DuolingoCertificate
    queryset = model_class.objects.all()
    serializer_class = abroadin.apps.estimation.form.serializers.DuolingoCertificateSerializer
...
class WantToApplyListCreateAPIView(custom_generic_apiviews.BaseListCreateAPIView):
    queryset = abroadin.apps.estimation.form.models.WantToApply.objects.all()
    serializer_class = abroadin.apps.estimation.form.serializers.WantToApplySerializer
    request_serializer_class = abroadin.apps.estimation.form.serializers.WantToApplyRequestSerializer

    def get_queryset(self):
        user = self.request.user
        sdi_id = self.request.query_params.get('student-detailed-info', None)
        qs = student_detailed_info_many_to_one_qs(user, sdi_id, abroadin.apps.estimation.form.models.WantToApply)
        return qs
...
class PublicationListCreateAPIView(custom_generic_apiviews.BaseListCreateAPIView):
    queryset = abroadin.apps.estimation.form.models.Publication.objects.all()
    serializer_class = abroadin.apps.estimation.form.serializers.PublicationSerializer
    request_serializer_class = abroadin.apps.estimation.form.serializers.PublicationRequestSerializer

    def get_queryset(self):
        user = self.request.user
        sdi_id = self.request.query_params.get('student-detailed-info', None)
        qs = student_detailed_info_many_to_one_qs(user, sdi_id, abroadin.apps.estimation.form.models.Publication)
        return qs
...
class StudentDetailedUniversityThroughListCreateAPIView(custom_generic_apiviews.BaseListCreateAPIView):
    queryset = abroadin.apps.estimation.form.models.UniversityThrough.objects.all()
    serializer_class = abroadin.apps.estimation.form.serializers.UniversityThroughSerializer
    request_serializer_class = abroadin.apps.estimation.form.serializers.UniversityThroughRequestSerializer

    def get_queryset(self):
        user = self.request.user
        sdi_id = self.request.query_params.get('student-detailed-info', None)
        qs = student_detailed_info_many_to_one_qs(user, sdi_id,
                                                  abroadin.apps.estimation.form.models.UniversityThrough)
        return qs
