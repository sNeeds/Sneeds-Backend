...
urlpatterns = [
    path('applied-redeem-codes/', views.ApplyRedeemCodesAPIView.as_view(), name='applied-redeem-code-list'),
    path('applied-redeem-codes/<int:id>/', views.ApplyRedeemCodeAPIView.as_view(), name='applied-redeem-code-detail'),
    ...
    path('invite-origin-choices/', views.InviteOriginChoicesListView.as_view(), name='invite-origin-choice-list'),
