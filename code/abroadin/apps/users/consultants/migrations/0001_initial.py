    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_picture', models.ImageField(upload_to=abroadin.apps.users.consultants.models.get_consultant_image_path)),
                ('aparat_link', models.URLField(blank=True, null=True)),
                ('resume', models.FileField(blank=True, null=True, upload_to=abroadin.apps.users.consultants.models.get_consultant_resume_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('field_of_study', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='account.major')),
