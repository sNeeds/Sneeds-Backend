...
class ProductQuerySet(models.QuerySet):
    ...
    def get_basic_products(self):
        from sNeeds.apps.store.basicProducts.models import BasicProduct
    ...
    def get_webinar_products(self):
        # from sNeeds.apps.store.basicProducts.models import WebinarProduct
    ...
    def get_class_products(self):
        # from sNeeds.apps.store.basicProducts.models import ClassProduct
...
class SoldProductQuerySet(models.QuerySet):
    ...
    def get_sold_basic_products(self):
        from sNeeds.apps.store.basicProducts.models import SoldBasicProduct
    ...
    def get_sold_class_products(self):
        from sNeeds.apps.store.basicProducts.models import SoldClassProduct
    ...
    def get_sold_webinar_products(self):
        from sNeeds.apps.store.basicProducts.models import SoldWebinarProduct
