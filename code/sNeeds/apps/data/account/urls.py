...
import sNeeds.apps.users.consultants.views
from . import views
...
urlpatterns = [
    ...
    path('consultant-profiles/', sNeeds.apps.users.consultants.views.ConsultantProfileList.as_view(),
         name="consultant-profile-list"),
    path('consultant-profiles/<str:slug>/', sNeeds.apps.users.consultants.views.ConsultantProfileDetail.as_view(),
